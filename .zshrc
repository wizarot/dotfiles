...
alias sf:entitys="sf doctrine:generate:entities"
alias sf:sch:validate="sf doctrine:schema:validate"
alias sf:sch:update="sf doctrine:schema:update"
alias sf:i18n="sf wiz:tools:i18n-update"
